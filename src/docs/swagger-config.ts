...
const swaggerDefinition = {
    openapi: "3.0.3",
    info: {
        title: "The User Management API: Securely Managing User Accounts",
        description: "This API covers a range of essential features for user management systems, including authentication, email confirmation, password reset, user information retrieval, and user search. It supports the standard flows required to create, manage, and interact with user accounts securely and efficiently.",
